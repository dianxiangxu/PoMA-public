...
public class MutatorROB extends MutantTester2 {
//	String testMethod = "P";

	public MutatorROB(String testMethod, Graph graph, String obligationPath) throws GraphDoesNotMatchTestSuitException {
...
//		System.out.println(obligation.getLabel());//label:GPMS Obligations
		...
		for (Rule rule : rules) {
			...
			testMutant(graph, mutant, testSuite, testMethod, getNumberOfMutants(), "ROR");
